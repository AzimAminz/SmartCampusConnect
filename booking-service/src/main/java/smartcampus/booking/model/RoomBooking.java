...
public class RoomBooking {
    ...
    @PrePersist
    public void onCreate() { this.bookedAt = LocalDateTime.now(); }
    ...
    public RoomBooking(String bookingReference, String studentId, String studentName,
        ...
        this.bookingReference = bookingReference; this.studentId = studentId;
        this.studentName = studentName; this.roomName = roomName;
        this.slot = slot; this.bookingDate = bookingDate;
        this.purpose = purpose; this.status = BookingStatus.CONFIRMED;
    }
