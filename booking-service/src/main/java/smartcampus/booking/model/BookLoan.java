...
public class BookLoan {
    ...
    public enum LoanStatus { BORROWED, RETURNED, OVERDUE, LOST }
    ...
    public BookLoan(String loanReference, String studentId, String studentName,
        ...
        this.loanReference = loanReference; this.studentId = studentId;
        this.studentName = studentName; this.bookIsbn = bookIsbn;
        this.bookTitle = bookTitle; this.loanDate = loanDate;
        this.dueDate = dueDate; this.status = LoanStatus.BORROWED;
    }
