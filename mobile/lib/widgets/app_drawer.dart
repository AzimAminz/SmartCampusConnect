...
class AppDrawer extends StatelessWidget {
        ...
        children: [
          ...
          UserAccountsDrawerHeader(
            ...
            accountEmail: Column(
              ...
              children: [
                Text(userId, style: const TextStyle(color: Colors.white70, fontSize: 13)),
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildDrawerItem(
                  ...
                  route: 'courses',
                  onTap: () => _navigate(context, const CourseEnrolmentScreen()),
                ),
                _buildDrawerItem(
                  context: context,
                ...
                _buildDrawerItem(
                  ...
                  title: isAdmin ? 'Student Loan Lookup' : 'My Borrowing History',
                  route: 'loan_history',
                ...
                if (isAdmin)
                  _buildDrawerItem(
                    ...
                    route: 'library_admin',
                    onTap: () => _navigate(context, const AdminManageBooksScreen()),
                  ),
                if (isAdmin)
                  _buildDrawerItem(
                    context: context,
                    ...
                    route: 'students',
                    onTap: () => _navigate(context, const AdminStudentManagementScreen()),
                  ),
                const Divider(color: Colors.white10),
                _buildDrawerItem(
                  context: context,
  ...
  Widget _buildDrawerItem({
    ...
    return ListTile(
      leading: Icon(
        icon,
        color: isSelected ? const Color(0xFF00BFA5) : Colors.white70, // Mint green for selected
      ),
      title: Text(
        title,
        style: TextStyle(
