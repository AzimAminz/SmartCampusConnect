...
class _AdminManageBooksScreenState extends State<AdminManageBooksScreen> {
  ...
  Future<void> _fetchLoans() async {
    ...
    try {
      ...
      setState(() {
        _activeLoans = loans.where((l) => l.status == 'BORROWED' || l.status == 'OVERDUE').toList();
        _isLoading = false;
      });
    } catch (e) {
      setState(() {
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          title: const Text('Add Book to Catalog', style: TextStyle(color: Colors.white)),
          content: Form(
            key: formKey,
              ...
              child: Column(
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'ISBN Code', labelStyle: TextStyle(color: Colors.white70)),
                    validator: (v) => v == null || v.isEmpty ? 'Required' : null,
                  ),
                  TextFormField(
                    controller: titleController,
                    style: const TextStyle(color: Colors.white),
                    decoration: const InputDecoration(labelText: 'Book Title', labelStyle: TextStyle(color: Colors.white70)),
                    validator: (v) => v == null || v.isEmpty ? 'Required' : null,
                  ),
                  TextFormField(
                    controller: authorController,
                    style: const TextStyle(color: Colors.white),
                    decoration: const InputDecoration(labelText: 'Author Name', labelStyle: TextStyle(color: Colors.white70)),
                    validator: (v) => v == null || v.isEmpty ? 'Required' : null,
                  ),
                  TextFormField(
                      ...
                      try {
                        ...
                        if (success && mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Book added to library successfully!'), backgroundColor: Color(0xFF00BFA5)),
                          );
                        }
                      } catch (e) {
          ...
          return AlertDialog(
            ...
            title: Row(
              children: [
                ...
                Text(
                  currentStep == 1 ? 'Select Book to Issue' : 'Verify & Enter Details',
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              onPressed: () => runSearch(searchController.text.trim()),
                            ),
                            filled: true,
                        ...
                        ConstrainedBox(
                          ...
                          child: isSearching
                              ...
                              : searchResults.isEmpty
                                  ? const Center(child: Padding(
                                      padding: EdgeInsets.all(20.0),
                                      child: Text('No books found.', style: TextStyle(color: Colors.white38)),
                                    ))
                                  : ListView.builder(
                                      shrinkWrap: true,
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return Card(
                                          ...
                                          shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(10),
                                            side: BorderSide(
                                              color: isAvail ? Colors.white10 : Colors.redAccent.withOpacity(0.2),
                                            ),
                                          ),
                                          child: ListTile(
                                            ...
                                            subtitle: Column(
                                              ...
                                              children: [
                                                Text('✍️ ${book.author ?? "Unknown"}', style: const TextStyle(color: Colors.white38, fontSize: 11)),
                                                Text('ISBN: ${book.isbn}', style: const TextStyle(color: Colors.white24, fontSize: 10, fontFamily: 'monospace')),
                                              ],
                                            ),
                                            trailing: Container(
                                              ...
                                              child: Text(
                                                book.status,
                                                style: TextStyle(
                                                  color: isAvail ? const Color(0xFF00BFA5) : Colors.redAccent,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 9,
                                                ),
                                              ),
                          ...
                          children: [
                            ...
                            if (selectedBook != null) ...[
                              Container(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text('SELECTED BOOK', style: TextStyle(color: Colors.white60, fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 0.8)),
                                    ...
                                    Text('ISBN: ${selectedBook!.isbn}', style: const TextStyle(color: Colors.white70, fontSize: 11, fontFamily: 'monospace')),
                                  ],
                                ),
                              ),
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: isVerifying
                                    ...
                                    : isVerified
                                        ? const Icon(Icons.check_circle_rounded, color: Color(0xFF00BFA5))
                                        : null,
                              ),
                              onChanged: (val) {
                                ...
                                debounceTimer = Timer(const Duration(milliseconds: 600), () async {
                                  ...
                                  try {
                                    ...
                                    final response = await ApiService.get('/reporting/student/$matric');
                                    if (response != null && response.containsKey('student')) {
                                      final studentData = response['student'];
                                      final name = studentData['name'] ?? 'Unknown';
                                      final prog = studentData['programme'] ?? 'N/A';
                                      final fac = studentData['faculty'] ?? 'N/A';

                                      // 2. Fetch loan history to run validation on current loan counts from SOAP
                                      final token = context.read<AuthProvider>().token!;
                                      final loans = await SoapService.getStudentLoanHistory(token: token, studentId: matric);
                                      
                                      // Count active loans (status is BORROWED or OVERDUE)
                                      final activeLoans = loans.where((l) => l.status == 'BORROWED' || l.status == 'OVERDUE').toList();
                                      final count = activeLoans.length;
                                      final hasOverdue = activeLoans.any((l) => l.status == 'OVERDUE');

                                      String? warning;
                                      if (count >= 3) {
                                        warning = 'Had Pinjam Buku Terlebih! Pelajar telah meminjam $count buku (Had maksima: 3).';
                                      } else if (hasOverdue) {
                                        warning = 'Pelajar mempunyai buku lewat yang belum dipulangkan!';
                                      }
                                    ...
                                    setDialogState(() {
                                      ...
                                      activeLoansCount = 0;
                                      hasOverdueLoans = false;
                                      verificationError = 'No Matrik tiada dalam pangkalan data!';
                                      isVerifying = false;
                                    });
                                  }
                                });
                              },
                              validator: (v) => v == null || v.trim().isEmpty ? 'Matric ID is required' : null,
                            ),
                            const SizedBox(height: 12),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          validationWarning != null ? 'VALIDATION WARNING' : 'STUDENT VERIFIED',
                                          style: TextStyle(
                                            color: validationWarning != null ? Colors.amber : const Color(0xFF00BFA5),
                                            fontSize: 10,
                                            fontWeight: FontWeight.bold,
                                            letterSpacing: 1.0,
                                          ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        const Text('Active Library Loans:', style: TextStyle(color: Colors.white38, fontSize: 11)),
                                        Text(
                                          '$activeLoansCount / 3 books',
                                          style: TextStyle(
                                            color: activeLoansCount >= 3 ? Colors.redAccent : Colors.white70,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 11,
                                          ),
                                        ),
                                    ...
                                    if (hasOverdueLoans) ...[
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: const [
                                          Text('Overdue Books Alert:', style: TextStyle(color: Colors.redAccent, fontSize: 11)),
                                          Text(
                                            'OVERDUE DETECTED',
                                            style: TextStyle(
                            ...
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                suffixIcon: Icon(Icons.calendar_today_rounded, color: Color(0xFF00BFA5), size: 20),
                              ),
                              validator: (v) => v == null || v.isEmpty ? 'Required' : null,
                              onTap: () async {
                                DateTime? picked = await showDatePicker(
                                  context: context,
                                  initialDate: selectedDate ?? DateTime.now().add(const Duration(days: 14)),
            ...
            actions: [
              ...
              if (currentStep == 2)
                ElevatedButton(
                  style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF3F51B5)),
                  onPressed: (isSaving || !isVerified || validationWarning != null)
                      ? null
                      : () async {
                          if (!formKey.currentState!.validate()) return;
                          setDialogState(() => isSaving = true);
                          try {
                            ...
                            if (mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Book issued successfully!'), backgroundColor: Color(0xFF00BFA5)),
                              );
                            }
                          } catch (e) {
                            setDialogState(() => isSaving = false);
                  ...
                  child: isSaving
                      ? const SizedBox(height: 16, width: 16, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white))
                      : const Text('Issue Loan', style: TextStyle(color: Colors.white)),
                ),
            ],
          );
        },
  ...
  void _confirmReturn(BookLoan loan) {
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          backgroundColor: const Color(0xFF1E1E1E),
          title: const Text('Confirm Return', style: TextStyle(color: Colors.white)),
          content: Text(
            ...
            ElevatedButton(
              ...
              onPressed: isSaving
                  ...
                  : () async {
                      ...
                      try {
                        final token = context.read<AuthProvider>().token!;
                        final success = await SoapService.returnBook(token: token, loanRef: loan.loanReference);
                        if (success && mounted) {
                          Navigator.of(ctx).pop();
                          _fetchLoans(); // Refresh
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Book returned successfully!'), backgroundColor: Color(0xFF00BFA5)),
                          );
                        }
                      } catch (e) {
                        setDialogState(() => isSaving = false);
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    icon: const Icon(Icons.library_add_rounded, color: Color(0xFF00BFA5)),
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    icon: const Icon(Icons.bookmark_add_rounded, color: Color(0xFF3F51B5)),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                title: Text(loan.bookTitle ?? 'Unknown Book', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                                subtitle: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const SizedBox(height: 6),
                                    Text('Matric: ${loan.studentId} (${loan.studentName ?? "N/A"})', style: const TextStyle(color: Colors.white70, fontSize: 13)),
                                    const SizedBox(height: 4),
                                    ...
                                    const SizedBox(height: 4),
                                    Text('Return Due: ${loan.dueDate}', style: TextStyle(color: loan.status == 'OVERDUE' ? Colors.redAccent : Colors.white54, fontSize: 13)),
                                    const SizedBox(height: 4),
                                    Text('Loan Ref: ${loan.loanReference}', style: const TextStyle(color: Colors.white24, fontSize: 11, fontFamily: 'monospace')),
                                  ],
                                ),
                                trailing: ElevatedButton(
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(8),
                                      side: const BorderSide(color: Color(0xFF00BFA5), width: 0.8),
                                    ),
                                  ),
